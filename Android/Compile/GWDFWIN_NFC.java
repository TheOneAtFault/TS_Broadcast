...
////////////////////////////////////////////////////////////////////////////
WDObjet vWD_nICounter = new WDEntier4();

WDObjet vWD_sContent = new WDChaineU();

WDObjet vWD_color = WDVarNonAllouee.ref;
WDObjet vWD_tag = WDVarNonAllouee.ref;


// nICounter is int = 0

vWD_nICounter.setValeur(0);


// sContent is string = "-"

vWD_sContent.setValeur("-");


// color is Color = LightRed
vWD_color = new WDInstance( new WDCouleurWL() );

vWD_color.setValeur(255);


// tag is nfcTag
vWD_tag = new WDInstance( new WDNFCTag() );


// tag = NFCReadTag()
vWD_tag.setValeur(WDAPINFC.NFCLitTag());

// IF NOT ErrorOccurred THEN		
if((!WDObjet.ErreurDetectee.getBoolean()))
{
// 	PROGBAR_Progress_bar..Color = LightRed		
mWD_PROGBAR_Progress_bar.setProp(EWDPropriete.PROP_COULEUR,255);

// 	FOR EACH data OF tag..Data
IWDParcours parcours1 = null;
try
{
WDObjet vWD_data = WDParcoursFactory.creerVariableParcours(vWD_tag.getProp(EWDPropriete.PROP_DONNEE));
parcours1 = WDParcoursFactory.pourTout(vWD_tag.getProp(EWDPropriete.PROP_DONNEE), vWD_data, null, null, null, 0x0, 0x2);
...
{
WDObjet _WDExpSelon0 = parcours1.getVariableParcours().getProp(EWDPropriete.PROP_TYPE);
if(_WDExpSelon0.opEgal(2))
{
// 				sContent = "Reading Tag type of " + data..Type
vWD_sContent.setValeur(new WDChaineU("Reading Tag type of ").opPlus(parcours1.getVariableParcours().getProp(EWDPropriete.PROP_TYPE)));

// 				sContent = sContent + data..Content
vWD_sContent.setValeur(vWD_sContent.opPlus(parcours1.getVariableParcours().getProp(EWDPropriete.PROP_CONTENU)));

// 				color = DarkYellow
vWD_color.setValeur(32896);
...
// 				color..Color = Gold
vWD_color.setProp(EWDPropriete.PROP_COULEUR,55295);

}
else if(_WDExpSelon0.opEgal(1))
{
// 				sContent = sContent + "Empty"
vWD_sContent.setValeur(vWD_sContent.opPlus("Empty"));

// 				color = DarkCyan
vWD_color.setValeur(8421376);

}
else if(_WDExpSelon0.opEgal(-1))
{
// 				sContent = "Error"
vWD_sContent.setValeur("Error");

// 				color = PastelMagenta
vWD_color.setValeur(16751103);

}
else {
// 				color = LightGreen
vWD_color.setValeur(65280);
...
// 	STC_CardDetails = sContent
mWD_STC_CardDetails.setValeur(vWD_sContent);

// 	PROGBAR_Progress_bar..Color = color
mWD_PROGBAR_Progress_bar.setProp(EWDPropriete.PROP_COULEUR,vWD_color);

// 	Info(sContent)
WDAPIDialogue.info(vWD_sContent.getString());
