...
public static void FindShopper()
{
	...
	findShopper.find( leActivity ,leContext );
}

public static class FindShopperClass extends Activity {
	Context ctx;
	Activity act = getCurrentActivity();
	public void find(Activity activity, Context context)
	{		
		ctx = context;
